...
const SYMBOL_TO_FILE: Record<string, string> = {
  ...
  createAppHost: 'app-bridge',
  AppHost: 'app-bridge',
  AppHostConfig: 'app-bridge',
  AppHostStatus: 'app-bridge',
  AppCapabilities: 'app-bridge',
  HostCapabilities: 'app-bridge',
  HostContext: 'app-bridge',
  McpUiDisplayMode: 'app-bridge',
  McpUiResourceCsp: 'app-bridge',
  McpUiPermissions: 'app-bridge',
  McpUiToolMeta: 'app-bridge',
  UiResourceMeta: 'app-bridge',
  buildAppCsp: 'app-bridge',
  buildAppPermissionsAllow: 'app-bridge',
  decodeJsonRpc: 'app-bridge',
  JsonRpcId: 'app-bridge',
  JsonRpcRequest: 'app-bridge',
  JsonRpcNotification: 'app-bridge',
  JsonRpcSuccess: 'app-bridge',
  JsonRpcFailure: 'app-bridge',
  JsonRpcMessage: 'app-bridge',
  APP_PROTOCOL_VERSION: 'app-bridge',
  APP_RESOURCE_MIME_TYPE: 'app-bridge',
  APP_EXTENSION_ID: 'app-bridge',
  // mcp/oauth.ts
