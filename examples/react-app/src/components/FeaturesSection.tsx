...
const features = [
  {
    ...
    description:
      'React and Angular adapters, powered by one shared component system.',
    hue: 250,
  },
  {
    icon: (
    ...
    description:
      'Tailwind v4 with OKLCH colors. Zero JavaScript runtime for styles.',
    hue: 170,
  },
  {
    icon: (
    ...
    title: 'Own Your Code',
    description:
      'CLI copies source into your project. No npm dependency lock-in.',
    hue: 30,
  },
  {
    icon: (
    ...
    description:
      'Light, Dark, and Glass themes. Live switchable with one attribute.',
    hue: 320,
  },
  {
    icon: (
        ...
        >
          {features.map((feature, index) => (
            <Card
              ...
              style={{
                borderLeft: `3px solid oklch(0.7 0.15 ${feature.hue})`,
                opacity: inView ? 1 : 0,
                transform: inView ? 'translateY(0)' : 'translateY(20px)',
                transition: `opacity 600ms ease-out, transform 600ms ease-out, box-shadow 200ms ease, translate 200ms ease`,
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{ color: `oklch(0.7 0.15 ${feature.hue})` }}
                  >
                    {feature.icon}
                  </div>
