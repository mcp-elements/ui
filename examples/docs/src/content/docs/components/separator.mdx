...
<Tabs>
  ...
  <TabItem label="Angular">
    ...
    import { SnxSeparatorComponent } from '@mcp-elements/angular';
    ...
    @Component({
      ...
      template: `
        <div class="w-full max-w-sm">
          <div class="space-y-1">
            <h4 class="text-sm font-medium leading-none">mcp-elements</h4>
            <p class="text-xs text-muted-foreground">
              A framework-agnostic component library.
            </p>
          </div>
          <mcpe-separator class="my-3" />
          <div class="flex items-center gap-3 text-xs">
            <span>Docs</span>
            <mcpe-separator orientation="vertical" class="h-4" />
            <span>Source</span>
            <mcpe-separator orientation="vertical" class="h-4" />
            <span>CLI</span>
          </div>
