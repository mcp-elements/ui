...
**Next concrete step** (resume here): **Commit the CLI registry work** (4 files in `packages/cli/src` + new `packages/cli/test/`, uncommitted on `main`). Then: launch posts (I7–I11), align README/npm "31 base + 7 MCP" framing with site's "24+7+7=38", and Stage G (Vue MCP components, issue #4).
